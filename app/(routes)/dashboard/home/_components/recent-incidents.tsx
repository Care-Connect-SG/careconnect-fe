...
const RecentIncidents = () => (
  <div className="bg-white rounded-lg border border-gray-200 p-6">
    ...
    <div className="space-y-4">
      {[
        { title: "Fall Incident", resident: "John Smith", time: "30 min ago", severity: "High", status: "Under Review" },
        { title: "Medication Error", resident: "Mary Johnson", time: "2 hours ago", severity: "Medium", status: "Resolved" },
        { title: "Behavioral Issue", resident: "Robert Davis", time: "4 hours ago", severity: "Low", status: "Documented" },
      ].map((incident, i) => (
