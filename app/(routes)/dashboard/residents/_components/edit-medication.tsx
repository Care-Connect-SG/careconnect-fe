...
const EditMedication: React.FC<EditMedicationProps> = ({ residentId, medication, isOpen, onClose, onMedicationUpdated }) => {
    ...
    return (
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="max-w-lg w-full p-6 rounded-lg shadow-lg">
                <DialogHeader>
                    <DialogTitle className="text-xl font-semibold text-gray-800">Edit Medication</DialogTitle>
                </DialogHeader>

                <div className="space-y-4">
                    <Label>Medication Name</Label>
                    <Input name="medication_name" value={form.medication_name} onChange={handleChange} />
