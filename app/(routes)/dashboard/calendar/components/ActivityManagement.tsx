...
const Breadcrumb = () => (
  <div className="flex items-center text-sm text-gray-600 mb-6">
    ...
    <a href="#" className="hover:text-blue-600">Calendar Management</a>
    <ChevronRight className="w-4 h-4 mx-2" />
  ...
  <div className="bg-white border border-gray-200 rounded-lg p-6 mb-6">
    <div className="flex items-center justify-between">
      <div>
        ...
        <p className="text-sm text-gray-600 mt-1">Manage and schedule activities for residents</p>
      </div>
            ...
            <div className="flex items-start justify-between">
              <div className="flex-1">
                <div className="flex items-center space-x-3">
                  ...
                  <span
                    className={`px-2 py-1 text-xs rounded-full ${item.status === "Upcoming" ? "bg-yellow-100 text-yellow-800" : "bg-gray-100 text-gray-800"}`}
                  >
                    {item.status}
                  </span>
                </div>
