...
export interface ConditionRecord {
    ...
    date_of_diagnosis: string; // ISO date string
  ...
  export interface AllergyRecord {
    ...
    date_first_noted: string; // ISO date string
    severity: string;
  ...
  export interface ChronicIllnessRecord {
    id: string;
    illness_name: string;
    date_of_onset: string; // ISO date string
  ...
  export interface ImmunizationRecord {
    ...
    next_due_date?: string; // ISO date string, optional
    resident_id?: string;
  }
