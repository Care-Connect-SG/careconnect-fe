  ...
  const formatMealPlan = (mealPlan: string | undefined) => {
    ...
    return (
      <div className="ml-4 text-sm text-gray-700">
        <p>
          <strong>Breakfast:</strong> {meals[0] || "N/A"}
        </p>
        <p>
          <strong>Lunch:</strong> {meals[1] || "N/A"}
        </p>
        <p>
          <strong>Dinner:</strong> {meals[2] || "N/A"}
        </p>
      </div>
    );
  };
      ...
      <CardContent className="px-6 py-4 space-y-4">
        ...
        <div>
          ...
          <div className="mt-2 space-y-1 text-sm text-gray-700 px-4">
            <p>
              ...
              {careplan.medical_conditions || "N/A"}
            </p>
            <p>
              <strong>Doctor Appointments:</strong>{" "}
              {careplan.doctor_appointments || "N/A"}
            </p>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="mt-2 space-y-1 text-sm text-gray-700 px-4">
            ...
            <div className="ml-4">
              {formatDietaryRestrictions(careplan.dietary_restrictions)}
            </div>
            <p>
            ...
            <p>
              <strong>Hydration:</strong> {careplan.hydration || "N/A"}
            </p>
            <p>
              <strong>Nutritional Supplements:</strong>{" "}
              {careplan.nutritional_supplements || "N/A"}
            </p>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="mt-2 space-y-1 text-sm text-gray-700 px-4">
            <p>
              <strong>Bathing Assistance:</strong>{" "}
              {careplan.bathing_assistance ? "Yes" : "No"}
            </p>
            <p>
              <strong>Dressing Assistance:</strong>{" "}
              {careplan.dressing_assistance ? "Yes" : "No"}
            </p>
            <p>
              <strong>Required Assistance:</strong>{" "}
              {careplan.required_assistance || "N/A"}
            </p>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="mt-2 space-y-1 text-sm text-gray-700 px-4">
            <p>
              ...
              {careplan.hobbies_interests || "N/A"}
            </p>
            <p>
              <strong>Social Interaction Plan:</strong>{" "}
              {careplan.social_interaction_plan || "N/A"}
            </p>
          </div>
        </div>
      </CardContent>
